 ...
 */
package com.mohammed.flutter_mpv_video;
...
public class VideoOutput implements TextureRegistry.SurfaceProducer.Callback {
    ...
    static {
        try {
            // com.mohammed.mediakitandroidhelper.FlutterMpvAndroidHelper is part of package:flutter_mpv_libs_android_video & package:flutter_mpv_libs_android_audio packages.
            // Use reflection to invoke methods of com.mohammed.mediakitandroidhelper.FlutterMpvAndroidHelper.
            Class<?> mediaKitAndroidHelperClass = Class.forName("com.mohammed.mediakitandroidhelper.FlutterMpvAndroidHelper");
            ...
            Log.i("flutter_mpv", "package:flutter_mpv_libs_android_video missing. Make sure you have added it to pubspec.yaml.");
            throw new RuntimeException("Failed to initialize com.mohammed.flutter_mpv_video.VideoOutput.");
        }
    }
